...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "cvscreenerui/test/integration/FirstJourney",
    "cvscreenerui/test/integration/CandidatesListJourney",
    "cvscreenerui/test/integration/CandidatesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
